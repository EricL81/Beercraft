...
<section id="form" class="book-a-table">
    <div class="container">
        <div class="section-title">
            <h2>Registrate a <span>Beercraft</span></h2>
        ...
        @csrf
            <div class="row">
                ...
                <div class="col-lg-6 offset-md-3 form-group mt-3 mt-md-0">
                    <input type="password" class="form-control" name="password_confirmation" id="email" placeholder="Confirm your Password" data-rule="password" data-msg="Please enter a valid password">
                    <div class="validate"></div>
                </div>
